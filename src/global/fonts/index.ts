...
export const fontStyles = css`
  ...
  @font-face {
    ...
    font-display: swap;
    src: local('OperatorMonoSSm-Book'),
      url(${OperatorMonoBookWoff2}) format('woff2'),
      url(${OperatorMonoBookWoff}) format('woff');
  }
  @font-face {
    font-family: 'OperatorMono-BookItalic';
    font-display: swap;
    src: local('OperatorMonoSSm-BookItalic'),
      url(${OperatorMonoBookItalicWoff2}) format('woff2'),
      url(${OperatorMonoBookItalicWoff}) format('woff');
  }
  @font-face {
    font-family: 'OperatorMono-Medium';
    font-display: swap;
    src: local('OperatorMonoSSm-Medium'),
      url(${OperatorMonoMediumWoff2}) format('woff2'),
